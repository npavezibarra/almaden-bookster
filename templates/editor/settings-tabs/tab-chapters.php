            ...
            <div>
                ...
                <div class="grid grid-cols-5 gap-2 mb-2">
                    ...
                    <div>
                        ...
                        <select id="setting-chapter-prefix-align" class="w-full bg-[var(--bg-app)] border border-[var(--border-color)] rounded-lg p-1.5 text-xs focus:outline-none focus:ring-2 focus:ring-black">
        ...
        <div id="chapter-settings-inner-title" class="settings-inner-panel-card chapter-settings-inner-tab-content space-y-6 hidden">
            <div>
                ...
                <label class="flex items-center gap-2 rounded-lg border border-[var(--border-color)] bg-[var(--bg-app)] px-3 py-2 text-xs font-semibold text-[var(--text-main)] mt-2">
                    <input type="checkbox" id="setting-chapter-title-hyphenate" class="h-3.5 w-3.5 rounded border-[var(--border-color)] text-black focus:ring-black">
                    <span>Hyphenate</span>
                </label>
            </div>
        </div>
