...
*   **[bookshelf-app.php](bookshelf-app.php)**: Renderiza el catálogo público de ebooks en la parte frontal de WordPress, con cards que muestran portada, título, resumen, metadatos y un CTA hacia la ficha individual.
