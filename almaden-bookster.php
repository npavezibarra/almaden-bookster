...
require_once plugin_dir_path( __FILE__ ) . 'includes/payments/commerce-providers.php';
require_once plugin_dir_path( __FILE__ ) . 'includes/payments/commerce-hardening.php';
...
function almaden_bookster_create_settings_table() {
	...
	$table_exists = almaden_bookster_table_exists( $table_name );
		...
		$sql = "CREATE TABLE $table_name (
			...
			letter_spacing_h1 float DEFAULT 0.0 NOT NULL,
			hyphenate_h1 tinyint(1) DEFAULT 0 NOT NULL,
			...
			letter_spacing_h2 float DEFAULT 0.0 NOT NULL,
			hyphenate_h2 tinyint(1) DEFAULT 0 NOT NULL,
			...
			letter_spacing_h3 float DEFAULT 0.0 NOT NULL,
			hyphenate_h3 tinyint(1) DEFAULT 0 NOT NULL,
			margin_top_h3 float DEFAULT 16.0 NOT NULL,
			margin_bottom_h3 float DEFAULT 8.0 NOT NULL,
			quote_font_family varchar(50) DEFAULT 'Merriweather' NOT NULL,
			quote_font_size float DEFAULT 11.5 NOT NULL,
			quote_font_style varchar(20) DEFAULT 'normal' NOT NULL,
			quote_font_weight varchar(20) DEFAULT 'bold' NOT NULL,
			quote_line_height float DEFAULT 1.4 NOT NULL,
			quote_text_align varchar(20) DEFAULT 'left' NOT NULL,
			quote_margin_top float DEFAULT 10.0 NOT NULL,
			quote_margin_bottom float DEFAULT 10.0 NOT NULL,
			quote_indent float DEFAULT 14.0 NOT NULL,
			table_font_family varchar(50) DEFAULT 'Merriweather' NOT NULL,
			table_font_size float DEFAULT 10.0 NOT NULL,
			table_font_style varchar(20) DEFAULT 'normal' NOT NULL,
			table_font_weight varchar(20) DEFAULT 'normal' NOT NULL,
			table_line_height float DEFAULT 1.35 NOT NULL,
			table_text_align varchar(20) DEFAULT 'left' NOT NULL,
			table_cell_padding float DEFAULT 6.0 NOT NULL,
			table_border_width float DEFAULT 0.75 NOT NULL,
			table_letter_spacing float DEFAULT 0.0 NOT NULL,
			table_border_color varchar(20) DEFAULT '#d9d9d9' NOT NULL,
			table_header_bg_color varchar(20) DEFAULT '#eeeeee' NOT NULL,
			table_cell_bg_color varchar(20) DEFAULT 'transparent' NOT NULL,
			...
			footnote_chapter_new_page tinyint(1) DEFAULT 0 NOT NULL,
			...
			heading_keep_with_next_enabled tinyint(1) DEFAULT 1 NOT NULL,
			heading_keep_with_next_lines tinyint(2) DEFAULT 3 NOT NULL,
			heading_keep_with_next_h1 tinyint(1) DEFAULT 1 NOT NULL,
			heading_keep_with_next_h2 tinyint(1) DEFAULT 1 NOT NULL,
			heading_keep_with_next_h3 tinyint(1) DEFAULT 1 NOT NULL,
			...
			ebook_chapter_title_font_style varchar(20) DEFAULT 'normal' NOT NULL,
			...
			ebook_chapter_title_hyphenate tinyint(1) DEFAULT 0 NOT NULL,
			...
			ebook_chapter_prefix_align varchar(10) DEFAULT 'center' NOT NULL,
			...
			chapter_image_default varchar(10) DEFAULT '0' NOT NULL,
			...
			chapter_page_one_align varchar(20) DEFAULT 'center-top' NOT NULL,
			...
			chapter_title_hyphenate tinyint(1) DEFAULT 0 NOT NULL,
			...
			chapter_prefix_align varchar(10) DEFAULT 'center' NOT NULL,
			...
			chapter_subtitle_show tinyint(1) DEFAULT 1 NOT NULL,
			chapter_subtitle_font_family varchar(50) DEFAULT '' NOT NULL,
			chapter_subtitle_font_size float DEFAULT 16.0 NOT NULL,
			chapter_subtitle_align varchar(20) DEFAULT 'center' NOT NULL,
			chapter_subtitle_font_style varchar(20) DEFAULT 'normal' NOT NULL,
			chapter_subtitle_text_transform varchar(20) DEFAULT 'none' NOT NULL,
			chapter_subtitle_font_weight varchar(20) DEFAULT 'normal' NOT NULL,
			chapter_subtitle_margin_top float DEFAULT 0.5 NOT NULL,
			chapter_subtitle_margin_bottom float DEFAULT 0.5 NOT NULL,
			chapter_subtitle_letter_spacing float DEFAULT 0.0 NOT NULL,
			PRIMARY KEY  (id),
