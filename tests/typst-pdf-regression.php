...
$required_typography = array(
		...
		'#align(left)[',
		'#set par(justify: false, first-line-indent: 0pt, leading: 0.5em)' . "\n" . '#align(right)[#heading(level: 1)[#almaden-page-colored("content", fill => text(fill: fill, font: "Outfit", size: 21pt, weight: 800, style: "normal", tracking: 1.2pt, hyphenate: true)[Encabezado de prueba])] <almaden-heading-2-h_0>]',
		'#set par(justify: false, first-line-indent: 0pt, leading: 0.25em)' . "\n" . '#align(center)[#heading(level: 2)[#almaden-page-colored("content", fill => text(fill: fill, font: "Inter Tight", size: 15pt, weight: 700, style: "italic", tracking: 0.4pt, hyphenate: false)[Subencabezado de prueba])] <almaden-heading-2-h_1>]',
		'#set par(justify: false, first-line-indent: 0pt, leading: 0.1em)' . "\n" . '#align(left)[#heading(level: 3)[#almaden-page-colored("content", fill => text(fill: fill, font: "Libertinus Serif", size: 13pt, weight: 500, style: "normal", tracking: -0.1pt, hyphenate: false)[Bajada de prueba])] <almaden-heading-2-h_2>]',
