...
window.getBookPageMapSignature = function() {
    const chapters = (bookState.chapters || []).map(ch => ({
        ...
        opening_separate_content: ch.opening_separate_content,
        chapter_image_enabled: ch.chapter_image_enabled,
        chapter_image_mode: ch.chapter_image_mode,
        chapter_image_url: ch.chapter_image_url,
        chapter_image_inner_width: ch.chapter_image_inner_width,
        ...
        toc_separate_opening_content: ch.toc_separate_opening_content,
        credits_hide_header: ch.credits_hide_header,
