(function () {
	...
	function renderPreview() {
		...
		previewList.innerHTML = [
			...
			'      <input type="text" data-preview-field="question-title" value="' + (QB.esc ? QB.esc(activeQuestion && activeQuestion.title ? activeQuestion.title : '') : (activeQuestion && activeQuestion.title ? activeQuestion.title : '')) + '">',
			'    </div>',
			'    <div class="almaden-slide-field">',
