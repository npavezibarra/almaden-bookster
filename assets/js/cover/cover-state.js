...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.CoverEditor.elements = {
        ...
        bookFormatSectionToggle: document.getElementById('toggle-book-format-section'),
        bookFormatSectionIcon: document.getElementById('book-format-section-icon'),
        bookFormatSectionContent: document.getElementById('book-format-section-content'),
        foldXWrapper: document.getElementById('fold-x-wrapper'),
        foldXMm: document.getElementById('fold-x'),
