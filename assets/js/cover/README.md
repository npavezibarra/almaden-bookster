...
*   **[cover-layers.js](cover-layers.js)**:
...
*   **[cover-layers-canvas.js](cover-layers-canvas.js)**:
...
*   **[cover-layers-panel.js](cover-layers-panel.js)**:
...
*   **[cover-book-format.js](cover-book-format.js)**:
...
*   **[cover-layers-interactions.js](cover-layers-interactions.js)**:
...
*   **[cover-dimensions.js](cover-dimensions.js)**:
...
*   **[cover-image-diagnostics-format.js](cover-image-diagnostics-format.js)**, **[cover-image-diagnostics-render.js](cover-image-diagnostics-render.js)** y **[cover-image-diagnostics-bootstrap.js](cover-image-diagnostics-bootstrap.js)**:
...
*   **[cover-export.js](cover-export.js)**:
