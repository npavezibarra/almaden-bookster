...
- [editor-visual-editor.js](editor-visual-editor.js)
- [editor-visual-session.js](editor-visual-session.js)
- [editor-chapters-utils.js](editor-chapters-utils.js)
- [editor-chapters-save.js](editor-chapters-save.js)
- [editor-chapters-actions.js](editor-chapters-actions.js)
- [editor-chapters-sidebar.js](editor-chapters-sidebar.js)
- `editor-pdf-html.js`
- [editor-style.css](../../css/editor-style.css)
...
*   **[editor-core.js](editor-core.js)**
    ...
    *   **Funciones Clave**:
        *   [trackEditorSelection](editor-core.js#L5): Captura la posición exacta de la selección del cursor en el textarea del editor.
        *   [initEventListeners](editor-core.js#L104): Bindea escuchas a entradas de texto, redimensionamiento de pantalla y clicks de autoguardado manual.
...
*   **[editor-ui.js](editor-ui.js)**
    ...
    *   **Funciones Clave**:
        *   [setViewMode](editor-ui.js#L4): Conmuta clases CSS para cambiar la vista (`split`, `edit`, `preview`).
        *   [changeTheme](editor-ui.js#L39): Cambia el esquema visual global (`light`, `sepia`, `dark`).
        *   [toggleSpreadView](editor-ui.js#L78): Alterna la visualización de una sola página con la de doble página encarada (spread layout).
        *   [renderRuler](editor-ui.js#L174): Dibuja y calibra la regla física milimétrica. En base al modo de vista (spread o single page), calcula el punto cero exactamente alineado con el lomo central divisor de Paged.js.
        *   [showToast](editor-ui.js#L109): Dispara notificaciones flotantes temporales con animaciones.
...
*   **Módulos de capítulos**
    ...
    *   **Funciones Clave**:
        *   [editor-chapters-utils.js](editor-chapters-utils.js): Recuento de palabras, extractos breves y helpers de DOM.
        *   [editor-chapters-sidebar.js](editor-chapters-sidebar.js): Render del sidebar de capítulos y reordenación visual con drag and drop.
        *   [editor-chapters-actions.js](editor-chapters-actions.js): Carga del capítulo activo, selección, creación, borrado y movimiento.
        *   [editor-chapters-save.js](editor-chapters-save.js): Autoguardado, serialización AJAX y `window.calculateAllPagesBackground`.

*   **[editor-chapter-settings-guide.js](editor-chapter-settings-guide.js)**, **[editor-chapter-settings-labels.js](editor-chapter-settings-labels.js)**, **[editor-chapter-settings-controls.js](editor-chapter-settings-controls.js)** y **[editor-chapter-settings-modal.js](editor-chapter-settings-modal.js)**:
...
*   **`editor-toolbar.js`**
    ...
    *   **Funciones Clave**:
        *   `wrapText`: Envuelve la selección o el cursor con prefijos y sufijos Markdown (ej. `**` para negritas), restaurando automáticamente el foco al editor.
        *   `addPrefix`: Inserta prefijos a nivel de inicio de línea (listas, cabeceras, blockquotes).
        *   `openMediaUploader` / `openParityImageUploader`: Instancia la interfaz de WordPress Media para insertar etiquetas de imagen personalizadas en el cursor o asociar imágenes de paridad al capítulo actual.

*   **[editor-markdown.js](editor-markdown.js)**
...
*   **[editor-settings-api.js](editor-settings-api.js)**
...
*   **[editor-settings-tabs.js](editor-settings-tabs.js)**
...
*   **[editor-settings-fields.js](editor-settings-fields.js)**
...
*   **[editor-settings-credits.js](editor-settings-credits.js)** (y sus submódulos)
...
*   **[editor-settings-templates.js](editor-settings-templates.js)**
    ...
    *   **Funciones Clave**:
        *   [loadBookTemplates](editor-settings-templates.js#L4): Solicita presets de formato persistidos en el repositorio de `Book Templates` y los dibuja en el modal.
        *   [applyBookTemplate](editor-settings-templates.js#L68): Carga los valores de un book template preestablecido y simula eventos de interacción del usuario en cada input para actualizar el estado global.

---

### 5. Rendimiento y Virtualización

*   **[editor-virtualization.js](editor-virtualization.js)**
...
1. El compilador en `editor-pdf-compiler.js` inyecta una sección vacía para la imagen de paridad `.chapter-parity-section-${id}` antes de la sección de contenido principal `.chapter-section-${id}` si el capítulo está configurado para iniciar en página impar (`odd`).
