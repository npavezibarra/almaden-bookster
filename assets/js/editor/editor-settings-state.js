...
window.almadenBuildPDFSettingsState = function(ctx) {
    ...
    return {
        ...
        line_height_h1: parseVal('setting-line-height-h1', 1.3),
        line_height_h2: parseVal('setting-line-height-h2', 1.4),
        line_height_h3: parseVal('setting-line-height-h3', 1.4),
        text_align_h1: getVal('setting-text-align-h1'),
        text_align_h2: getVal('setting-text-align-h2'),
        text_align_h3: getVal('setting-text-align-h3'),
        letter_spacing_h1: parseVal('setting-letter-spacing-h1', 0),
        letter_spacing_h2: parseVal('setting-letter-spacing-h2', 0),
        letter_spacing_h3: parseVal('setting-letter-spacing-h3', 0),
        margin_top_h1: parseVal('setting-margin-top-h1', 0),
        margin_top_h2: parseVal('setting-margin-top-h2', 0),
        margin_top_h3: parseVal('setting-margin-top-h3', 0),
        margin_bottom_h1: parseVal('setting-margin-bottom-h1', 0),
        margin_bottom_h2: parseVal('setting-margin-bottom-h2', 0),
        margin_bottom_h3: parseVal('setting-margin-bottom-h3', 0),
        ...
        quote_font_family: getVal('setting-quote-font-family'),
        quote_font_size: parseVal('setting-quote-font-size', 11.5),
        quote_font_style: getVal('setting-quote-font-style'),
        quote_font_weight: getVal('setting-quote-font-weight'),
        quote_line_height: parseVal('setting-quote-line-height', 1.4),
        quote_text_align: getVal('setting-quote-text-align'),
        quote_margin_top: parseVal('setting-quote-margin-top', 10),
        quote_margin_bottom: parseVal('setting-quote-margin-bottom', 10),
        quote_indent: parseVal('setting-quote-indent', 14),
        table_font_family: getVal('setting-table-font-family') || getVal('setting-font-family-content'),
        table_font_size: parseVal('setting-table-font-size', 10),
        table_font_style: getVal('setting-table-font-style') || 'normal',
        table_font_weight: getVal('setting-table-font-weight') || 'normal',
        table_line_height: parseVal('setting-table-line-height', 1.35),
        table_text_align: getVal('setting-table-text-align') || 'left',
        table_cell_padding: parseVal('setting-table-cell-padding', 6),
        table_border_width: parseVal('setting-table-border-width', 0.75),
        table_letter_spacing: parseVal('setting-table-letter-spacing', 0),
        table_border_color: getVal('setting-table-border-color') || '#d9d9d9',
        table_header_bg_color: getVal('setting-table-header-bg-color') || '#eeeeee',
        table_cell_bg_color: getVal('setting-table-cell-bg-color') || 'transparent',
        ...
        heading_keep_with_next_enabled: getChecked('setting-heading-keep-with-next-enabled'),
        heading_keep_with_next_lines: parseVal('setting-heading-keep-with-next-lines', 3),
        heading_keep_with_next_h1: getChecked('setting-heading-keep-with-next-h1'),
        heading_keep_with_next_h2: getChecked('setting-heading-keep-with-next-h2'),
        heading_keep_with_next_h3: getChecked('setting-heading-keep-with-next-h3'),
