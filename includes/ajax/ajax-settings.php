...
function almaden_bookster_save_settings_ajax() {
	...
	$data = array(
		...
		'ebook_chapter_title_hyphenate'  => isset($_POST['ebook_chapter_title_hyphenate']) ? intval($_POST['ebook_chapter_title_hyphenate']) : 0,
		...
		'ebook_chapter_prefix_align' => isset($_POST['ebook_chapter_prefix_align']) ? sanitize_text_field($_POST['ebook_chapter_prefix_align']) : 'center',
		...
		'line_height_h1'             => isset( $_POST['line_height_h1'] ) ? max( 0.8, min( 4.0, floatval( str_replace( ',', '.', $_POST['line_height_h1'] ) ) ) ) : 1.3,
		'line_height_h2'             => isset( $_POST['line_height_h2'] ) ? max( 0.8, min( 4.0, floatval( str_replace( ',', '.', $_POST['line_height_h2'] ) ) ) ) : 1.4,
		'line_height_h3'             => isset( $_POST['line_height_h3'] ) ? max( 0.8, min( 4.0, floatval( str_replace( ',', '.', $_POST['line_height_h3'] ) ) ) ) : 1.4,
		'text_align_h1'              => ( isset( $_POST['text_align_h1'] ) && in_array( $_POST['text_align_h1'], array( 'left', 'center', 'right' ), true ) ) ? sanitize_text_field( $_POST['text_align_h1'] ) : 'center',
		'text_align_h2'              => ( isset( $_POST['text_align_h2'] ) && in_array( $_POST['text_align_h2'], array( 'left', 'center', 'right' ), true ) ) ? sanitize_text_field( $_POST['text_align_h2'] ) : 'left',
		'text_align_h3'              => ( isset( $_POST['text_align_h3'] ) && in_array( $_POST['text_align_h3'], array( 'left', 'center', 'right' ), true ) ) ? sanitize_text_field( $_POST['text_align_h3'] ) : 'left',
		'letter_spacing_h1'          => isset( $_POST['letter_spacing_h1'] ) ? max( -20.0, min( 20.0, floatval( str_replace( ',', '.', $_POST['letter_spacing_h1'] ) ) ) ) : 0,
		'letter_spacing_h2'          => isset( $_POST['letter_spacing_h2'] ) ? max( -20.0, min( 20.0, floatval( str_replace( ',', '.', $_POST['letter_spacing_h2'] ) ) ) ) : 0,
		'letter_spacing_h3'          => isset( $_POST['letter_spacing_h3'] ) ? max( -20.0, min( 20.0, floatval( str_replace( ',', '.', $_POST['letter_spacing_h3'] ) ) ) ) : 0,
		'margin_top_h1'              => isset( $_POST['margin_top_h1'] ) ? max( 0.0, min( 200.0, floatval( str_replace( ',', '.', $_POST['margin_top_h1'] ) ) ) ) : 0,
		'margin_top_h2'              => isset( $_POST['margin_top_h2'] ) ? max( 0.0, min( 200.0, floatval( str_replace( ',', '.', $_POST['margin_top_h2'] ) ) ) ) : 0,
		'margin_top_h3'              => isset( $_POST['margin_top_h3'] ) ? max( 0.0, min( 200.0, floatval( str_replace( ',', '.', $_POST['margin_top_h3'] ) ) ) ) : 0,
		'margin_bottom_h1'           => isset( $_POST['margin_bottom_h1'] ) ? max( 0.0, min( 200.0, floatval( str_replace( ',', '.', $_POST['margin_bottom_h1'] ) ) ) ) : 0,
		'margin_bottom_h2'           => isset( $_POST['margin_bottom_h2'] ) ? max( 0.0, min( 200.0, floatval( str_replace( ',', '.', $_POST['margin_bottom_h2'] ) ) ) ) : 0,
		'margin_bottom_h3'           => isset( $_POST['margin_bottom_h3'] ) ? max( 0.0, min( 200.0, floatval( str_replace( ',', '.', $_POST['margin_bottom_h3'] ) ) ) ) : 0,
		'hyphenate_h1'               => isset( $_POST['hyphenate_h1'] ) ? intval( $_POST['hyphenate_h1'] ) : 0,
		'hyphenate_h2'               => isset( $_POST['hyphenate_h2'] ) ? intval( $_POST['hyphenate_h2'] ) : 0,
		'hyphenate_h3'               => isset( $_POST['hyphenate_h3'] ) ? intval( $_POST['hyphenate_h3'] ) : 0,
		'quote_font_family'          => isset( $_POST['quote_font_family'] ) ? sanitize_text_field( $_POST['quote_font_family'] ) : sanitize_text_field( $_POST['font_family_content'] ),
		'quote_font_size'            => isset( $_POST['quote_font_size'] ) ? max( 5.0, min( 100.0, floatval( str_replace( ',', '.', $_POST['quote_font_size'] ) ) ) ) : 11.5,
		'quote_font_style'           => isset( $_POST['quote_font_style'] ) ? sanitize_text_field( $_POST['quote_font_style'] ) : 'normal',
		'quote_font_weight'          => isset( $_POST['quote_font_weight'] ) ? sanitize_text_field( $_POST['quote_font_weight'] ) : 'bold',
		'quote_line_height'          => isset( $_POST['quote_line_height'] ) ? max( 0.8, min( 4.0, floatval( str_replace( ',', '.', $_POST['quote_line_height'] ) ) ) ) : 1.4,
		'quote_text_align'           => ( isset( $_POST['quote_text_align'] ) && in_array( $_POST['quote_text_align'], array( 'left', 'center', 'right' ), true ) ) ? sanitize_text_field( $_POST['quote_text_align'] ) : 'left',
		'quote_margin_top'           => isset( $_POST['quote_margin_top'] ) ? max( 0.0, min( 200.0, floatval( str_replace( ',', '.', $_POST['quote_margin_top'] ) ) ) ) : 10,
		'quote_margin_bottom'        => isset( $_POST['quote_margin_bottom'] ) ? max( 0.0, min( 200.0, floatval( str_replace( ',', '.', $_POST['quote_margin_bottom'] ) ) ) ) : 10,
		'quote_indent'               => isset( $_POST['quote_indent'] ) ? max( 0.0, min( 200.0, floatval( str_replace( ',', '.', $_POST['quote_indent'] ) ) ) ) : 14,
		'table_font_family'          => isset( $_POST['table_font_family'] ) ? sanitize_text_field( $_POST['table_font_family'] ) : sanitize_text_field( $_POST['font_family_content'] ),
		'table_font_size'            => isset( $_POST['table_font_size'] ) ? max( 5.0, min( 100.0, floatval( str_replace( ',', '.', $_POST['table_font_size'] ) ) ) ) : 10.0,
		'table_font_style'           => isset( $_POST['table_font_style'] ) && in_array( $_POST['table_font_style'], array( 'normal', 'italic', 'oblique' ), true ) ? sanitize_text_field( $_POST['table_font_style'] ) : 'normal',
		'table_font_weight'          => isset( $_POST['table_font_weight'] ) ? sanitize_text_field( $_POST['table_font_weight'] ) : 'normal',
		'table_line_height'          => isset( $_POST['table_line_height'] ) ? max( 0.8, min( 4.0, floatval( str_replace( ',', '.', $_POST['table_line_height'] ) ) ) ) : 1.35,
		'table_text_align'           => ( isset( $_POST['table_text_align'] ) && in_array( $_POST['table_text_align'], array( 'left', 'center', 'right', 'justify' ), true ) ) ? sanitize_text_field( $_POST['table_text_align'] ) : 'left',
		'table_cell_padding'         => isset( $_POST['table_cell_padding'] ) ? max( 0.0, min( 60.0, floatval( str_replace( ',', '.', $_POST['table_cell_padding'] ) ) ) ) : 6.0,
		'table_border_width'         => isset( $_POST['table_border_width'] ) ? max( 0.0, min( 20.0, floatval( str_replace( ',', '.', $_POST['table_border_width'] ) ) ) ) : 0.75,
		'table_letter_spacing'       => isset( $_POST['table_letter_spacing'] ) ? max( -20.0, min( 20.0, floatval( str_replace( ',', '.', $_POST['table_letter_spacing'] ) ) ) ) : 0.0,
		'table_border_color'         => isset( $_POST['table_border_color'] ) ? sanitize_text_field( $_POST['table_border_color'] ) : '#d9d9d9',
		'table_header_bg_color'      => isset( $_POST['table_header_bg_color'] ) ? sanitize_text_field( $_POST['table_header_bg_color'] ) : '#eeeeee',
		'table_cell_bg_color'        => isset( $_POST['table_cell_bg_color'] ) ? sanitize_text_field( $_POST['table_cell_bg_color'] ) : 'transparent',
		...
		'heading_keep_with_next_enabled' => isset( $_POST['heading_keep_with_next_enabled'] ) ? intval( $_POST['heading_keep_with_next_enabled'] ) : 1,
		'heading_keep_with_next_lines' => isset( $_POST['heading_keep_with_next_lines'] ) ? max( 1, min( 8, intval( $_POST['heading_keep_with_next_lines'] ) ) ) : 3,
		'heading_keep_with_next_h1' => isset( $_POST['heading_keep_with_next_h1'] ) ? intval( $_POST['heading_keep_with_next_h1'] ) : 1,
		'heading_keep_with_next_h2' => isset( $_POST['heading_keep_with_next_h2'] ) ? intval( $_POST['heading_keep_with_next_h2'] ) : 1,
		'heading_keep_with_next_h3' => isset( $_POST['heading_keep_with_next_h3'] ) ? intval( $_POST['heading_keep_with_next_h3'] ) : 1,
		...
		'chapter_title_hyphenate'    => isset($_POST['chapter_title_hyphenate']) ? intval($_POST['chapter_title_hyphenate']) : 0,
		...
		'chapter_prefix_align'       => isset( $_POST['chapter_prefix_align'] ) ? sanitize_text_field( $_POST['chapter_prefix_align'] ) : 'center',
		...
		'chapter_subtitle_show'      => isset( $_POST['chapter_subtitle_show'] ) ? intval( $_POST['chapter_subtitle_show'] ) : 1,
		'chapter_subtitle_font_family' => isset( $_POST['chapter_subtitle_font_family'] ) ? sanitize_text_field( $_POST['chapter_subtitle_font_family'] ) : '',
		'chapter_subtitle_font_size' => isset( $_POST['chapter_subtitle_font_size'] ) ? floatval( str_replace( ',', '.', $_POST['chapter_subtitle_font_size'] ) ) : 16,
		'chapter_subtitle_align'     => ( isset( $_POST['chapter_subtitle_align'] ) && in_array( $_POST['chapter_subtitle_align'], array( 'left', 'center', 'right' ), true ) ) ? sanitize_text_field( $_POST['chapter_subtitle_align'] ) : 'center',
		'chapter_subtitle_font_style' => isset( $_POST['chapter_subtitle_font_style'] ) ? sanitize_text_field( $_POST['chapter_subtitle_font_style'] ) : 'normal',
		'chapter_subtitle_text_transform' => isset( $_POST['chapter_subtitle_text_transform'] ) ? sanitize_text_field( $_POST['chapter_subtitle_text_transform'] ) : 'none',
		'chapter_subtitle_font_weight' => isset( $_POST['chapter_subtitle_font_weight'] ) ? sanitize_text_field( $_POST['chapter_subtitle_font_weight'] ) : 'normal',
		'chapter_subtitle_margin_top' => isset( $_POST['chapter_subtitle_margin_top'] ) ? floatval( str_replace( ',', '.', $_POST['chapter_subtitle_margin_top'] ) ) : 0.5,
		'chapter_subtitle_margin_bottom' => isset( $_POST['chapter_subtitle_margin_bottom'] ) ? floatval( str_replace( ',', '.', $_POST['chapter_subtitle_margin_bottom'] ) ) : 0.5,
		'chapter_subtitle_letter_spacing' => isset( $_POST['chapter_subtitle_letter_spacing'] ) ? floatval( str_replace( ',', '.', $_POST['chapter_subtitle_letter_spacing'] ) ) : 0,
