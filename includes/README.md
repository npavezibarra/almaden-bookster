...
*   **[shell-access.php](file:///Users/nicolaspavez/Local%20Sites/almaden/app/public/wp-content/plugins/almaden-bookster/includes/frontend/shell-access.php)**: Permisos de las app pages internas del shell. Si un usuario anónimo entra a una pantalla privada como `Taller`, la lógica lo redirige a la URL pública con el modal de login abierto en lugar de mostrar la pantalla de acceso denegado.
*   **[reading-stats.php](file:///Users/nicolaspavez/Local%20Sites/almaden/app/public/wp-content/plugins/almaden-bookster/includes/frontend/reading-stats.php)**: Sincronizacion y agregados para la pantalla `My Reading Stats`.
